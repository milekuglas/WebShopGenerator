...
class ModuleGenerator(Generator):
    ...
    def generate_module_model(self, model):
        self.main_generator.generate("backend/module_template.scala",
                 os.path.join("backend", "app", model.project.package.name.replace(".", os.sep)), "Module.scala", {})
    ...
    def generate_initial_data_model(self, model):
        ...
        for category in model.categories:
            ...
            index += 1
        self.main_generator.generate("backend/initial_data_template.scala",
                    os.path.join("backend", "app", model.project.package.name.replace(".", os.sep)), "InitialData.scala",
